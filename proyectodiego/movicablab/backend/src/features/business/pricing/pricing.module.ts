...
import { StubCarreraActivaTarifaAdapter } from './infrastructure/adapters/stub-carrera-activa-tarifa.adapter';
...
/**
 * PricingModule — ISS-07.
 */
@Module({
  controllers: [TarifasController],
  providers: [
    { provide: TARIFA_REPOSITORY, useClass: TarifaRepository },
    { provide: CARRERA_ACTIVA_TARIFA_PORT, useClass: StubCarreraActivaTarifaAdapter },
    CreateTarifaUseCase,
    ListTarifasUseCase,
