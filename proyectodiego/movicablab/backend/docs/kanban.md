...
| #03 | Definir arquitectura por capas | REQ-S04-03 | #02 | Diagrama de arquitectura | Especificada |
| #04 | Definir contratos (DTO/API) | REQ-S04-04 | #02 | Contratos documentados | Especificada |
| #05 | Crear base del backend NestJS | REQ-S04-05 | Node LTS (S03) | Backend arranca + /api/health | Por especificar |
| #06 | Actualizar docs/sdd.md y docs/kanban.md | REQ-S04-06 | #01-#05 | SDD + Kanban trazables | Por especificar |
